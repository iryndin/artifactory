...
public class ArtifactResource extends SimpleRepoResource {
    ...
    private void init() {
        ...
        boolean metaData = MavenUtil.isMetaData(name);
        boolean hash = MavenUtil.isHash(name);
        ...
        if (!metaData && !hash) {
            ...
            boolean snapshot = MavenUtil.isVersionSnapshot(version);
            if (!snapshot) {
    ...
    public boolean isSnapshot() {
        return MavenUtil.isVersionSnapshot(version);
    }
