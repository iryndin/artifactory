...
public class MetadataValue {
    ...
    MetadataValue(MetadataKey key, Object metadataValue, long lastModified) {
        this.key = key;
    ...
    private void initNewMetadata(MetadataDefinition definition) {
        if (metadataValue != null) {
            newMetadataValue = definition.newInstance(metadataValue);
        } else {
    ...
    public void update(Object metadataValue, long lastModified) {
        synchronized (lock) {
