...
public class RemoteRepositoriesMapAdapter
        extends
        XmlAdapter<RemoteRepositoriesMapAdapter.Wrappper, OrderedMap<String, RemoteRepo>> {
    @SuppressWarnings({"UNUSED_SYMBOL", "UnusedDeclaration"})
    private final static Logger LOGGER = Logger.getLogger(RemoteRepositoriesMapAdapter.class);


    public OrderedMap<String, RemoteRepo> unmarshal(Wrappper wrapper)
            throws Exception {
    ...
    public RemoteRepositoriesMapAdapter.Wrappper marshal(
            OrderedMap<String, RemoteRepo> map)
            throws Exception {
        return new RemoteRepositoriesMapAdapter.Wrappper(map);
    }


    @XmlType(name = "RemoteRepositoriesType", namespace = CentralConfig.NS)
    public static class Wrappper {
        ...
        public Wrappper(OrderedMap<String, RemoteRepo> map) {
