...
import org.artifactory.ui.rest.service.artifacts.search.packagesearch.strategy.AqlUIDebianNameSearchStrategy;
...
public enum PackageSearchCriteria {
    ...
    debianName(PackageSearchType.debian, "name",
            new AqlUISearchModel("debianName", "Name", "Debian Name",
                    new AqlComparatorEnum[]{AqlComparatorEnum.matches}),
            new AqlUIDebianNameSearchStrategy(AqlFieldEnum.itemName,
...
/*    nugetTags(PackageSearchType.nuget, "nuget.tags",
   ...
   /* rpmRelease(PackageSearchType.rpm, "rpm.metadata.release",
    ...
    public enum PackageSearchType {
        ...
        pypi(RepoType.Pypi, false, "pypi"), gavc(RepoType.Maven, true, "pom"), vagrant(RepoType.Vagrant, false, "vagrant");
