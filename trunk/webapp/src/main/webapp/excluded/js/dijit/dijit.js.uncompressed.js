    ...
    dojo.mixin(dijit,
    {
        ...
        getFocus: function(/*Widget?*/menu, /*Window?*/openedForWindow) {
            ...
            return {
                ...
                node: menu && dojo.isDescendant(dijit._curFocus, menu.domNode) ? dijit._prevFocus :
                      dijit._curFocus,
        ...
        focus: function(/*Object || DomNode */ handle) {
            ...
            var node = "node" in handle ? handle.node :
                       handle,        // because handle is either DomNode or a composite object
            ...
            if (node) {
                var focusNode = (node.tagName.toLowerCase() == "iframe") ? node.contentWindow :
                                node;
            ...
            if (bookmark && dojo.withGlobal(openedForWindow || dojo.global, dijit.isCollapsed)) {
                ...
                try {
                    dojo.withGlobal(openedForWindow ||
                                    dojo.global, dijit.moveToBookmark, null, [bookmark]);
                } catch(e) {
    ...
    dijit._place = function(/*DomNode*/ node, /* Array */ choices, /* Function */ layoutNode) {
        ...
        dojo.some(choices, function(choice) {
            ...
            var startX = (corner.charAt(1) == 'L' ? pos.x : Math.max(view.l, pos.x - mb.w)),
                    ...
                    endX = (corner.charAt(1) == 'L' ? Math.min(view.l + view.w, startX + mb.w) :
                            pos.x),
                    endY = (corner.charAt(0) == 'T' ? Math.min(view.t + view.h, startY + mb.h) :
                            pos.y),
                    width = endX - startX,
                    height = endY - startY,
...
if (!dojo._hasResource["dijit._base.popup"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    dijit.popup = new function() {
        ...
        this.open = function(/*Object*/ args) {
            ...
            var widget = args.popup,
                    ...
                    around = args.around,
                    id = (args.around && args.around.id) ? (args.around.id + "_dropdown") :
                         ("popup_" + idGen++);
            ...
            var best = around ?
                       dijit.placeOnScreenAroundElement(wrapper, around, orient, widget.orient ?
                                                                                 dojo.hitch(widget, "orient") :
                                                                                 null) :
                       dijit.placeOnScreen(wrapper, args, orient == 'R' ? ['TR','BR','TL','BL'] :
                                                          ['TL','BL','TR','BR']);
            ...
            var getTopPopup = function() {
                for (var pi = stack.length - 1; pi > 0 && stack[pi].parent === stack[pi - 1].widget;
                     pi--) {
            ...
            handlers.push(dojo.connect(widget, widget.onExecute ? "onExecute" :
    ...
    dijit.BackgroundIframe = function(/* DomNode */node) {
        ...
        if ((dojo.isIE && dojo.isIE < 7) ||
            ...
            if (dojo.isIE) {
                iframe.style.setExpression("width", dojo._scopeName + ".doc.getElementById('" +
                                                    node.id + "').offsetWidth");
                iframe.style.setExpression("height", dojo._scopeName + ".doc.getElementById('" +
...
if (!dojo._hasResource["dijit._base.typematic"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    dijit.typematic = {
        ...
        addKeyListener: function(/*DOMNode*/ node, /*Object*/ keyObject, /*Object*/
                                             _this, /*Function*/ callback, /*Number*/
                                             subsequentDelay, /*Number*/ initialDelay) {
        ...
        addMouseListener: function(/*DOMNode*/ node, /*Object*/ _this, /*Function*/
                                               callback, /*Number*/ subsequentDelay, /*Number*/
                                               initialDelay) {
        ...
        addListener: function(/*Node*/ mouseNode, /*Node*/ keyNode, /*Object*/ keyObject, /*Object*/
                                       _this, /*Function*/ callback, /*Number*/
                                       subsequentDelay, /*Number*/ initialDelay) {
    ...
    dijit.wai = {
        onload: function() {
            ...
            if (cs) {
                ...
                var needsA11y = (cs.borderTopColor == cs.borderRightColor) || (bkImg != null &&
                                                                               (bkImg == "none" ||
                                                                                bkImg ==
                                                                                "url(invalid-url:)" ));
    ...
    dojo.mixin(dijit,
    {
        ...
        hasWaiState: function(/*Element*/ elem, /*String*/ state) {
            ...
            if (dojo.isFF && dojo.isFF < 3) {
                ...
                return elem.hasAttribute ? elem.hasAttribute("aria-" + state) :
...
if (!dojo._hasResource["dojo.date.stamp"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    dojo.date.stamp.fromISOString = function(/*String*/formattedString, /*Number?*/defaultTime) {
        ...
        if (match) {
            ...
            result =
            new Date(match[0] || 1970, match[1] || 0, match[2] || 1, match[3] || 0, match[4] ||
                                                                                    0, match[5] ||
                                                                                       0, match[6] ||
                                                                                          0);
    ...
    function(/*Date*/dateObject, /*dojo.date.stamp.__Options?*/options) {
        //	summary:
        ...
        if (options.selector != "time") {
            ...
            date = ["0000".substr((year + "").length) + year, _(dateObject[getter + "Month"]() +
                                                                1), _(dateObject[getter +
                                                                                 "Date"]())].join('-');
        }
        formattedDate.push(date);
        if (options.selector != "date") {
            var time = [_(dateObject[getter + "Hours"]()), _(dateObject[getter +
                                                                        "Minutes"]()), _(dateObject[getter +
                                                                                                    "Seconds"]())].join(':');
    ...
    dojo.parser = new function() {
        ...
        this.instantiate = function(/* Array */nodes) {
            ...
            d.forEach(nodes, function(node) {
                ...
                // create the instance
                var instance = markupFactory ? markupFactory(params, node, clazz) :
                               new clazz(params, node);
            ...
            if (this.domNode) {
                for (var attr in this.attributeMap) {
                    ...
                    if (typeof value != "object" &&
                        ((value !== "" && value !== false) || (params && params[attr]))) {
        ...
        setAttribute: function(/*String*/ attr, /*anything*/ value) {
            ...
            switch (attr) {
                ...
                default:
                    ...
                    if (typeof value ==
                        "function") { // functions execute in the context of the widget
...
if (!dojo._hasResource["dijit._Templated"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            null,
    {
        ...
        _attachTemplateNodes: function(rootNode, getAttrFunc) {
            ...
            var nodes = dojo.isArray(rootNode) ? rootNode :
    ...
    dijit._Templated._sanitizeTemplateString = function(/*String*/tString) {
        ...
        if (tString) {
            tString =
            tString.replace(/^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, "");
...
if (!dojo._hasResource["dijit.layout._LayoutWidget"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    (function() {
        ...
        function(/*DomNode*/ container, /*Object*/ dim, /*Object[]*/ children) {
            /**
             * summary
...
if (!dojo._hasResource["dijit.form._FormWidget"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    dojo.declare("dijit.form._FormWidget", [dijit._Widget, dijit._Templated],
    {
        ...
        setDisabled: function(/*Boolean*/ disabled) {
            ...
            dojo.deprecated("setDisabled(" + disabled +
                            ") is deprecated. Use setAttribute('disabled'," + disabled +
                            ") instead.", "", "2.0");
        ...
        setValue: function(/*String*/ value) {
            dojo.deprecated("dijit.form._FormWidget:setValue(" + value +
                            ") is deprecated.  Use setAttribute('value'," + value +
                            ") instead.", "", "2.0");
