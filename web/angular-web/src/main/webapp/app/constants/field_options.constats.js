export default {
    ...
    repoPackageTypes:[
        ...
        {"serverEnumName": "Docker", "value": "docker", "text": "Docker", "icon": 'docker', "repoType": ['local', 'remote'], "description": 'Docker allows you to package an application with all of its dependencies into a standardized unit for software development. A Docker repository will allow you to easily and securely manage your Docker images.'},
