...
class JFTreeBrowserController extends JFCommonBrowser {
    constructor($timeout, ArtifactoryEventBus, $element, $scope, TreeBrowserDao, $stateParams, $q, ArtifactoryState, ArtifactActions, ArtifactoryNotifications, NativeBrowser, User) {
    ...
    _transformData(data) {
        ...
        return data.map((node) => {
            ...
            item.text = node.isTrashcan() ? '<span class="trashcan-node">Trash Can</span>' : node.text;
            item.data = node;
