 ...
 */
@Component
public final class WicketAddonsImpl
        implements CoreAddons, WebApplicationAddon, PropertiesAddon, SearchAddon, WatchAddon,
        WebstartWebAddon, HttpSsoAddon {
    ...
    public TitledAjaxSubmitLink getLoginLink(String wicketId, Form form) {
