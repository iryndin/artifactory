...
public class LogbackConfigListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        LogbackConfigWatchDog configWatchDog = new LogbackConfigWatchDog(context);
        configureWatchdog(servletContext, configWatchDog);
    ...
    private void configureWatchdog(ServletContext servletContext, LogbackConfigWatchDog configWatchDog) {
