 ...
 */
@Test(enabled = false)
public class SecurityExportTest {
    ...
    private void testExportSecurity(ArtifactoryVersion version)
    ...
    private AbstractApplicationContext setVersionAndGetSpringContext(
        ...
        if (testHome == null) {
            Assert.fail("artifactory.test.home system property not set. " +
                    "This should point to a directory where you have installations of " +
                    "previous releases for testing.");
        }
