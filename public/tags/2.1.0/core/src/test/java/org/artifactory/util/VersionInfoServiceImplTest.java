...
public class VersionInfoServiceImplTest {
    ...
    public void testVersioningRetrieverJob() {
        ...
        expect(cacheService.getCache(ArtifactoryCache.versioning)).andReturn(Collections.emptyMap()).anyTimes();
        ...
        replay(context, cacheService, taskService, centralConfigService);
        ...
        verify(context, cacheService, taskService, centralConfigService);
