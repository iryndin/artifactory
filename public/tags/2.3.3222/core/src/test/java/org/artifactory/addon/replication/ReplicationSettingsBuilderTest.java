 ...
 */
@Test
public class ReplicationSettingsBuilderTest {

    @Test(expectedExceptions = IllegalArgumentException.class)
    public void testNoRepoPath() throws Exception {
        new ReplicationSettingsBuilder(null, null).build();
    }

    @Test(expectedExceptions = IllegalArgumentException.class)
    public void testNoWriter() throws Exception {
        new ReplicationSettingsBuilder(new RepoPathImpl("moo", "goo"), null).build();
    }

    @Test
    public void testDefaultValues() throws Exception {
        RepoPath repoPath = new RepoPathImpl("moo", "mieow");
        StringWriter stringWriter = new StringWriter();
        ReplicationSettings settings = new ReplicationSettingsBuilder(repoPath, stringWriter).build();
    ...
    public void testSetters() throws Exception {
        RepoPath repoPath = new RepoPathImpl("moo", "mieow");
        StringWriter stringWriter = new StringWriter();
        ReplicationSettings settings = new ReplicationSettingsBuilder(repoPath, stringWriter).progress(true).mark(15).
