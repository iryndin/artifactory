...
public interface UserGroupStoreService {
     ...
     */
    @Lock
    void changePassword(UserInfo user, SaltedPassword saltedPassword);
     ...
     */
    @Lock
    void unExpireUserPassword(String userName);
     ...
     */
    @Lock
    void unExpirePasswordsForAllUsers();
     ...
     * @param daysToChangePassword after what period password should be changed
     *
     * @return list of users
     */
    Map<UserInfo, Long> getUsersWitchPasswordIsAboutToExpire(int daysToStartNotificationsFrom, int daysToChangePassword);
