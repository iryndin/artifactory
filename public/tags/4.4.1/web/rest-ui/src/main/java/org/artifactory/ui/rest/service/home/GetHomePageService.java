...
public class GetHomePageService implements RestService {
    ...
    private void updateAddonList(HashMap<String, AddonInfo> addonInfoMap, List<AddonModel> addonModels) {
        ...
        addonModels.add(new AddonModel(AddonType.SSH,
                getAddonInfoForPro(AddonType.SSH),
                getAddonLearnMoreUrl("ssh"),
                getAddonConfigureUrl(AddonType.SSH.getConfigureUrlSuffix())));
