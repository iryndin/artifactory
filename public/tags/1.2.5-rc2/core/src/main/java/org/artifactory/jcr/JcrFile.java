...
public class JcrFile extends JcrFsItem {
    ...
    public void importFrom(String basePath, StatusHolder status) {
        ...
        try {
            ...
            if (metadataFile.exists()) {
                ...
                created.setTimeInMillis(metadata.getCreated());
                node.setProperty(JCR_CREATED, created);
    ...
    public FileMetadata getMetadata() {
        return new FileMetadata(repoKey(), relPath(), created() != null ? created().getTime() : -1,
                modifiedBy(), lastUpdated() != null ? lastUpdated().getTime() : -1,
