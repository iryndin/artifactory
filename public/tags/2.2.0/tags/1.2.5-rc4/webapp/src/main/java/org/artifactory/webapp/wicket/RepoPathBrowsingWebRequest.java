...
public class RepoPathBrowsingWebRequest extends ServletWebRequest {
    ...
    private final static Logger LOGGER = Logger.getLogger(RepoPathBrowsingWebRequest.class);
    ...
    public int getDepthRelativeToWicketHandler() {
        ...
        //Initialize
        RepoPath repoPath = ServletUtils.getRepoPath(this);
        if (repoPath != null) {
    ...
    private String getPrefix() {
        ...
        if (repoPath != null) {
            ...
            LOGGER.warn("Expected to find a repoPath on the request but none was found. " +
