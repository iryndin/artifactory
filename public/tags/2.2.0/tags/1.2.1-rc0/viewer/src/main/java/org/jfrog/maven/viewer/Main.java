 ...
 */
package org.jfrog.maven.viewer;
...
// TODO The entire class should be refactored. Right now it's a quick and dirty implementation !

public class Main {
    public static void main(String[] args) {
        Main m = new Main("/org/jfrog/maven/viewer/ctx");
    }

    public Main(String rootContextDirectoryClassPath) {
