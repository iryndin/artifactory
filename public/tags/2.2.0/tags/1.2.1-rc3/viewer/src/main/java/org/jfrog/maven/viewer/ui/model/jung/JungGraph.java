...
public class JungGraph implements Graph {
    ...
    public static final String TRANSITIVE_DEPTH = "depth";
    public static final String DEPENDENCY_SCOPE = "scope";
    public static final String DUMMY_VERTEX = "dummy";
    ...
    public void addAtrifactVertex(ArtifactIdentifier artifactIdentifier, int depth) {
        ...
        v.setUserDatum(ARTIFACT_IDENTIFIER, artifactIdentifier, UserData.SHARED);

        v.setUserDatum(TRANSITIVE_DEPTH, depth, UserData.SHARED);
    ...
    public void addMissingArtifactVertex(ArtifactIdentifier artifactIdentifier, int depth) {
        ...
        findVertex(artifactIdentifier).setUserDatum(DUMMY_VERTEX, Boolean.TRUE, UserData.SHARED);
    }
    ...
    public void createEdge(ArtifactIdentifier dependent, ArtifactIdentifier dependency, String scope) {
        ...
        edge.addUserDatum(DEPENDENCY_SCOPE, scope, UserData.SHARED);
        try {
            graph.addEdge(edge);
        } catch (Exception e) {
            logger.error(
