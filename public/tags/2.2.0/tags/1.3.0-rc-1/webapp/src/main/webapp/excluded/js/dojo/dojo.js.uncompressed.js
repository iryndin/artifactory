...
(function() {
    ...
    if ((sMap || (typeof djConfig != "undefined" && djConfig.scopeMap)) &&
        ...
        for (var i = 0; i < sMap.length; i++) {
            ...
            var newScope = sMap[i];
            scopeDef += "var " + newScope[0] + " = {}; " + newScope[1] + " = " + newScope[0] + ";" +
                        newScope[1] + "._scopeName = '" + newScope[1] + "';";
    ...
    (function() {
        ...
        dojo._loadPath = function(/*String*/relpath, /*String?*/module, /*Function?*/cb) {
            ...
            var uri = ((relpath.charAt(0) == '/' || relpath.match(/^\w+:/)) ? "" : this.baseUrl) +
                      relpath;
            try {
        ...
        dojo.loaded = function() {
            ...
            for (var x = 0; x < mll.length; x++) {
                try {
                    ...
                    /* let other load events fire, like the parser, but report the error */
                }
            }
        ...
        dojo.require = function(/*String*/moduleName, /*Boolean?*/omitModuleCheck) {
            ...
            if (!omitModuleCheck && !this._isXDomain) {
                ...
                if (!module) {
                    throw new Error("symbol '" + moduleName + "' is not defined after loading '" +
                                    relpath + "'");
                }
            }
    ...
    if (!dojo._hasResource["dojo._base.lang"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        dojo.isString = function(/*anything*/ it) {
            ...
            return !!arguments.length && it != null &&
                   (typeof it == "string" || it instanceof String); // Boolean
        }
        ...
        dojo.isObject = function(/*anything*/ it) {
            ...
            //		or null)
            return it !== undefined &&
                   (it === null || typeof it == "object" || dojo.isArray(it) ||
                    dojo.isFunction(it)); // Boolean
        }
    ...
    if (!dojo._hasResource["dojo._base.declare"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        dojo.declare =
        function(/*String*/ className, /*Function|Function[]*/ superclass, /*Object*/ props) {
            //	summary:
            ...
            } // 0[i] checks Object.prototype
            // decorate prototype
            dojo.extend(ctor, {declaredClass: className, _constructor: init, preamble: null}, props ||
                                                                                              0);
            // special help for IE
        ...
        dojo.mixin(dojo.declare, {
            _delegate: function(base, mixin) {
                ...
                // add mixin and core
                dojo.extend(ctor, dojo.declare._core, mp ||
                                                      0, {_constructor: null, preamble: null});
                // special help for IE
                ctor.prototype.constructor = ctor;
                // name this class for debugging
                ctor.prototype.declaredClass =
            ...
            _core: {
                ...
                _findMethod: function(name, method, ptype, has) {
                    ...
                    return !has && (p = this._findMixin(ptype)) &&
                           this._findMethod(name, method, p, has);
                },
                inherited: function(name, args, newArgs) {
                    ...
                    if (this[name] != c || p[name] == c) {
                        ...
                        if (!mp) {
                            throw(this.declaredClass + ': inherited method "' + name +
                                  '" mismatch');
                        }
    ...
    if (!dojo._hasResource["dojo._base.connect"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        dojo.subscribe =
        function(/*String*/ topic, /*Object|null*/ context, /*String|Function*/ method) {
            //	summary:
    ...
    if (!dojo._hasResource["dojo._base.array"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        (function() {
            ...
            dojo.mixin(dojo, {
                ...
                forEach: function(/*Array|String*/arr, /*Function|String*/callback, /*Object?*/
                                                  thisObject) {
                    // summary:
                ...
                _everyOrSome: function(/*Boolean*/every, /*Array|String*/arr, /*Function|String*/
                                                  callback, /*Object?*/thisObject) {
                    var _p = _getParts(arr, thisObject, callback);
                    arr = _p[0];
                ...
                every: function(/*Array|String*/arr, /*Function|String*/callback, /*Object?*/
                                                thisObject) {
                    // summary:
                ...
                some: function(/*Array|String*/arr, /*Function|String*/callback, /*Object?*/
                                               thisObject) {
                    // summary:
                ...
                map: function(/*Array|String*/arr, /*Function|String*/callback, /*Function?*/
                                              thisObject) {
                    // summary:
    ...
    if (!dojo._hasResource["dojo._base.event"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        (function() {
            ...
            dojo._connect = function(obj, event, context, method, dontFix) {
                ...
                var lid = !isNode ? 0 :
                          (!dontFix ? 1 : 2), l = [dojo._listener, del, node_listener][lid];
                // create a listener
            ...
            if (dojo.isIE) {
                ...
                dojo.mixin(del, {
                    ...
                    _fixEvent: function(/*Event*/evt, /*DOMNode*/sender) {
                        ...
                        if (!evt) {
                            var w = sender && (sender.ownerDocument || sender.document ||
                                               sender).parentWindow || window;
                            evt = w.event;
                        }
                        if (!evt) {
                            return(evt);
                        ...
                        var docBody = ((dojo.isIE < 6) || (doc["compatMode"] == "BackCompat")) ?
                                      doc.body : doc.documentElement;
                        var offset = dojo._getIeDocumentElementOffset();
                        evt.pageX =
                        evt.clientX + dojo._fixIeBiDiScrollLeft(docBody.scrollLeft || 0) - offset.x;
                    ...
                    _stealthKeyDown: function(evt) {
                        ...
                        var unprintable = (k != 13) && (k != 32) && (k != 27) &&
                                          (k < 48 || k > 90) && (k < 96 || k > 111) &&
    ...
    if (!dojo._hasResource["dojo._base.html"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        (function() {
            ...
            dojo._destroyElement = function(/*String||DomNode*/node) {
                ...
                try {
                    ...
                    _destroyContainer.appendChild(node.parentNode ?
            ...
            dojo.place =
            function(/*String|DomNode*/node, /*String|DomNode*/refNode, /*String|Number*/position) {
                //	summary:
            ...
            if (d.isIE /*|| dojo.isOpera*/) {
                ...
                "content-box"; // FIXME: remove IE < 6 support?
            }
            ...
            dojo._setBox =
            function(/*DomNode*/node, /*Number?*/l, /*Number?*/t, /*Number?*/w, /*Number?*/
                                h, /*String?*/u) {
                //	summary:
            ...
            function(/*DomNode*/node, /*Number*/widthPx, /*Number*/heightPx, /*Object*/
                                computedStyle) {
                //	summary:
            ...
            dojo._docScroll = function() {
                ...
                return {
                    ...
                    x: (_w.pageXOffset || d._fixIeBiDiScrollLeft(de.scrollLeft) || _b.scrollLeft ||
                        0)
                };
            };
            ...
            dojo.attr = function(/*DomNode|String*/node, /*String|Object*/name, /*String?*/value) {
                ...
                if (args == 3) {
                    ...
                    if (prop) {
                        ...
                        var value = node[name];
                        return (typeof value == 'boolean' || typeof value == 'function') ? value :
        ...
        dojo.toggleClass =
        function(/*DomNode|String*/node, /*String*/classStr, /*Boolean?*/condition) {
            //	summary:
    ...
    if (!dojo._hasResource["dojo._base.NodeList"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        (function() {
            ...
            dojo.extend(dojo.NodeList, {
                ...
                adopt: function(/*String||Array||DomNode*/ queryOrListOrNode, /*String?*/
                                                           position) {
                    //	summary:
                ...
                addContent: function(/*String*/ content, /*String||Integer?*/ position) {
                    ...
                    var ct = (position == "first" || position == "after") ? "lastChild" :
                             "firstChild";
                    this.forEach(function(item) {
                ...
                instantiate: function(/*String|Object*/ declaredClass, /*Object?*/ properties) {
                    ...
                    //		srcNodeRef
                    //
                    var c = d.isFunction(declaredClass) ? declaredClass :
                            d.getObject(declaredClass);
                    return this.forEach(function(i) {
                        new c(properties || {}, i);
                    }) // dojo.NodeList
                }
        ...
        (function() {
            ...
            var getSimpleFilterFunc = function(query) {
                ...
                d.forEach(query.classes, function(cname, idx, arr) {
                    ...
                    var re = new RegExp("(?:^|\\s)" + cname + (isWildcard ? ".*" : "") +
                                        "(?:\\s|$)");
                    ff = agree(ff, function(elem) {
            ...
            d._filterQueryResult = function(nodeList, simpleFilter) {
                ...
                var ff = (simpleFilter) ? getFilterFunc(getQueryParts(simpleFilter)[0]) :
                         function() {
                             return true;
                         };
    ...
    if (!dojo._hasResource["dojo._base.xhr"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        (function() {
            ...
            var _doIt = function(/*String*/type, /*Deferred*/dfd) {
                ...
                var xhr = ioArgs.xhr;
                xhr.open(type, ioArgs.url, args.sync !== true, args.user ||
