...
public class SecurityVersionTest extends VersionTest {
    ...
    public void convertFromvVersion1() throws IOException {
        ...
        File toConvert = TestUtils.getResourceAsFile("/security/v1/security.xml");
    ...
    public void convertFromvVersion1Big() throws IOException {
        File toConvert = TestUtils.getResourceAsFile("/security/v1/security-big.xml");
        String secXmlData = FileUtils.readFileToString(toConvert);
        String result = SecurityVersion.v1.convert(secXmlData);
    ...
    public void convertFromvVersion2() throws IOException {
        File toConvert = TestUtils.getResourceAsFile("/security/v2/security.xml");
        String secXmlData = FileUtils.readFileToString(toConvert);
    ...
    public void convertFromvVersion3() throws IOException {
        File toConvert = TestUtils.getResourceAsFile("/security/v3/security.xml");
        String secXmlData = FileUtils.readFileToString(toConvert);
