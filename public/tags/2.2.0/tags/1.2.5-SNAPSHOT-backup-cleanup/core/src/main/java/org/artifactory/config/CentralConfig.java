...
@XmlType(name = "CentralConfigType",
        propOrder = {"serverName", "anonDownloadsAllowed", "backup",
...
public class CentralConfig implements InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() {
        ...
        for (Repo repoConfig : getLocalAndRemoteRepositories()) {
    ...
    public synchronized List<Repo> getLocalAndRemoteRepositories() {
