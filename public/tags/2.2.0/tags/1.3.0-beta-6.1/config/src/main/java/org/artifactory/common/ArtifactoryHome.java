...
public abstract class ArtifactoryHome {
    ...
    public static CompoundVersionDetails getRunningArtifactoryVersion() {
        InputStream inputStream = ArtifactoryHome.class.getResourceAsStream(
                "/META-INF/" + ARTIFACTORY_PROPERTIES_FILE);
        return ArtifactoryVersionReader.read(inputStream);
    }
    ...
    private static void initAndLoadSystemPropertyFile() {
        ...
        CompoundVersionDetails runningVersion = getRunningArtifactoryVersion();
