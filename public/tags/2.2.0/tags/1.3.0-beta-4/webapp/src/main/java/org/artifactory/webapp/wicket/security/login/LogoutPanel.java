 ...
 * @author Yoav Aharoni
 */
public class LogoutPanel extends TitledPanel {

    public LogoutPanel(String string) {
        super(string);
        BookmarkablePageLink homeLink = new BookmarkablePageLink("home", HomePage.class);
        add(homeLink);
