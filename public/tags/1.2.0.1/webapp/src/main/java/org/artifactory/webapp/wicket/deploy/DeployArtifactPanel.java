 ...
 * @author Yoav Aharoni
 */
public class DeployArtifactPanel extends WindowPanel {
    ...
    class FileUploadForm extends Form {
        ...
        public FileUploadForm(String name) {
            ...
            //Set maximum upload size to 10M
