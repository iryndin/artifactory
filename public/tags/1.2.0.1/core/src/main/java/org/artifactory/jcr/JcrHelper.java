...
public class JcrHelper implements DisposableBean {
    ...
    public static void importStream(
        ...
        NodeLocker nodeLocker = new NodeLocker(parentNode);
        nodeLocker.lock();
     ...
     * @throws IOException
     */
    private static void importXml(Node xmlNode, InputStream in, Session session)
            throws RepositoryException, IOException {
