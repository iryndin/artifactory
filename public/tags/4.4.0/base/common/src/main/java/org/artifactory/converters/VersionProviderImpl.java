            ...
            if (dbPropertiesTableExists) {
                ...
                if (dbProperties == null) {
                    if (ConstantValues.test.getBoolean()) {
                        String version = v440.name();
                        String revision = valueOf(v440.getRevision());
                        originalDatabaseVersion = new CompoundVersionDetails(v440, version, revision, 1387059697274l);
                    } else {
