...
public class HttpRepo extends RemoteRepoBase<HttpRepoDescriptor> {
    ...
    public ResourceStreamHandle downloadResource(final String relPath, final RequestContext requestContext)
        ...
        return new MyRemoteResourceStreamHandle(response, urlWithParams, requestForPlugins, pluginAddon, repoPath, is);
    }
    ...
    private String encodeIfNeeded(String fullUrl, RequestContext requestContext) {
        ...
        return skipEncoding ? fullUrl : HttpUtils.encodeQuery(fullUrl);
    }
    ...
    protected RepoResource retrieveInfo(String path, boolean folder, @Nullable RequestContext requestContext) {
        ...
        try {
            ...
            return handleGetInfoResponse(repoPath, method, response, httpClientContext, requestContext);
        } catch (IOException e) {
    ...
    protected RepoResource handleGetInfoResponse(RepoPath repoPath, HttpRequestBase method,
        ...
        RepoResource res =
                new RemoteRepoResource(repoPath, lastModified, contentLength, checksums, response.getAllHeaders());
        return res;
    }
    ...
    protected CloseableHttpClient createHttpClient() {
        ...
        return new HttpClientConfigurator()
                ...
                .enableTokenAuthentication(isEnableTokenAuthentication(), getKey())
                .getClient();
    }
