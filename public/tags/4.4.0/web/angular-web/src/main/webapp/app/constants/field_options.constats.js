export default {
    ...
    repoPackageTypes:[
        ...
        },
        {
            ...
            "description": 'A Debian repository will allow you to host, cache and distribute your Debian packages for Debian based OSs such as Ubuntu.'
        },
        {
        ...
        },
        {
            ...
            "icon": 'ivy',
            "repoType": ['local', 'remote', 'virtual'],
            "description": 'Apache Ivy is a popular dependency manager focusing on flexibility and simplicity. Ivy offers full integration with ant, and a strong transitive dependencies management engine.'
        },
        {
            ...
            "icon": 'pom',
            "repoType": ['local', 'remote', 'virtual'],
            "description": 'Apache Maven is a build automation tool, and provides useful project information from your project’s sources.'
        },
        {
            "serverEnumName": "Npm",
            "value": "npm",
        ...
        },
        {
            ...
            "icon": 'nuget',
            "repoType": ['local', 'remote', 'virtual'],
            "description": 'NuGet is the package manager for the Microsoft development platforms including .NET. Host and proxy NuGet packages in Artifactory, and pull libraries from Artifactory into your various Visual Studio .NET applications.'
        },
        {
            "serverEnumName": "Opkg",
            "value": "opkg",
            ...
            "icon": 'opkg',
            "repoType": ['local', 'remote'],
            "description": 'Opkg is a lightweight package management system based upon ipkg. It is intended for use on embedded Linux devices.'
        },
        {
            "serverEnumName": "P2",
            "value": "p2",
