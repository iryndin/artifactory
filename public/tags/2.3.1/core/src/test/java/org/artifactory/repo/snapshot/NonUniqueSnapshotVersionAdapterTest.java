...
public class NonUniqueSnapshotVersionAdapterTest extends ArtifactoryHomeBoundTest {
    ...
    public void uniqueArtifact() {
        ...
        String result =
                nonUniqueAdapter.adaptSnapshotPath(new RepoPathImpl("local", SNAPSHOT_PATH + uniqueVersionFile));
    ...
    public void alreadyNonUniqueArtifact() {
        ...
        String result =
                nonUniqueAdapter.adaptSnapshotPath(new RepoPathImpl("local", SNAPSHOT_PATH + nonUniqueVersionFile));
        assertEquals(result, SNAPSHOT_PATH + "artifactId-1.4-SNAPSHOT.jar");
    }
    ...
    public void artifactWithNoMavenStructure() {
        ...
        String result = nonUniqueAdapter.adaptSnapshotPath(new RepoPathImpl("local", SNAPSHOT_PATH + nonMavenFile));
    ...
    public void uniqueArtifactVersionWithDashes() {
        ...
        String result = nonUniqueAdapter.adaptSnapshotPath(new RepoPathImpl("local", snapshotPath + uniqueVersionFile));
