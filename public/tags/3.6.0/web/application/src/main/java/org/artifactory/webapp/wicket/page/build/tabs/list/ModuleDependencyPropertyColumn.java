 ...
 * @author Shay Yaakov
 */
public class ModuleDependencyPropertyColumn extends PropertyColumn<ModuleDependencyActionableItem> {

    public ModuleDependencyPropertyColumn(IModel<String> displayModel, String sortProperty, String propertyExpression) {
