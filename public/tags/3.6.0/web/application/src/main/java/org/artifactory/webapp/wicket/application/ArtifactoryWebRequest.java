 ...
 *
 * Based on org.apache.wicket.protocol.http.servlet.ServletWebRequest
 */
...
/**
 * TODO: GET RID OF THIS CLASS ONCE https://issues.apache.org/jira/browse/WICKET-4387 IS FIXED
 * <p/>
 * {@link org.apache.wicket.request.http.WebRequest} subclass that wraps a {@link HttpServletRequest} object.
 *
 * @author Matej Knopp
 * @author Juergen Donnerstag
 * @author Igor Vaynberg
 */
public class ArtifactoryWebRequest extends ServletWebRequest {
     ...
     */
    public ArtifactoryWebRequest(HttpServletRequest httpServletRequest, String filterPrefix) {
    ...
    @Override
    public ArtifactoryWebRequest cloneWithUrl(Url url) {
        return new ArtifactoryWebRequest(httpServletRequest, filterPrefix, url) {
            @Override
            public IRequestParameters getPostParameters() {
                // don't parse post parameters again
                return ArtifactoryWebRequest.this.getPostParameters();
            }
        };
    }
     ...
     *
     * @param maxSize
     * @param upload  upload identifier for {@link org.apache.wicket.protocol.http.servlet.UploadInfo}
    ...
    private static final Logger logger = LoggerFactory.getLogger(ArtifactoryWebRequest.class);
