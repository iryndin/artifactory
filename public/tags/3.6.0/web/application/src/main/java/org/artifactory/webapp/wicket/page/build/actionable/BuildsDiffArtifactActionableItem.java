 ...
 * @author Shay Yaakov
 */
public class BuildsDiffArtifactActionableItem extends RepoAwareActionableItemBase implements BuildsDiffActionableItem {

    private BuildsDiffBaseFileModel model;

    public BuildsDiffArtifactActionableItem(BuildsDiffBaseFileModel model) {
