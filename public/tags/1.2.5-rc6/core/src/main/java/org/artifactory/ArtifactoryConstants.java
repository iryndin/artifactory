...
public abstract class ArtifactoryConstants {
    ...
    static String SYS_PROP_SEARCH_MAX_RESULTS = "artifactory.search.maxResults";
    static String SYS_PROP_GLOBAL_OFFLINE = "artifactory.globalOffline";
    static String SYS_PROP_MAVEN_SUPPRESS_POM_CONSISTENCY_CHECKS =
            "artifactory.maven.suppressPomConsistencyChecks";
    static String SYS_PROP_PREFIX_REPO_KEY_SUBST = "artifactory.repo.key.subst.";
