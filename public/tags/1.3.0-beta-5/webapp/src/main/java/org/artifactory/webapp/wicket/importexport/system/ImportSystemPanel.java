    ...
    public ImportSystemPanel(String string) {
        ...
        Form importForm = new Form("importForm") {
            ...
            protected void onSubmit() {
                MultiStatusesHolder status = new MultiStatusesHolder();
                ...
                try {
                    if (file.isArchive()) {
                        //Extract the archive
                        status.setStatus("Extracting archive...", LOGGER);
                        importFromFolder =
                    ...
                    status.setStatus("Importing from directory...", LOGGER);
                    ...
                    if (status.isError()) {
                        ...
                        if (status.getException() != null) {
                            LOGGER.warn(msg, status.getException());
                        }
                    } else {
