...
public enum ActionDescriptor {
    ...
    VIEW("view", "/images/eye.png"),
    DOWNLOAD("download", "/images/disk.png"),
    REMOVE("remove", "/images/delete.png"),
    ZAP("zap", "/images/lightning.png");

    private final String name;
    private final String iconRes;

    ActionDescriptor(String name, String iconRes) {
        this.name = name;
