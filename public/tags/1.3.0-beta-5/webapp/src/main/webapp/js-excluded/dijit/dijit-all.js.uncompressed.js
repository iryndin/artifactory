...
if (!dojo._hasResource["dojo.i18n"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    function(/*String*/packageName, /*String*/bundleName, /*String?*/locale) {
        //	summary:
        ...
        throw new Error("Bundle not found: " + bundleName + " in " + packageName + " , locale=" +
                        locale);
    };
    ...
    function(/*String*/moduleName, /*String*/bundleName, /*String?*/locale, /*String?*/
    ...
    function(/*String*/locale, /*Boolean*/down, /*Function*/searchFunc) {
        //	summary:
...
if (!dojo._hasResource["dijit.Declaration"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit._Widget,
    {
        ...
        buildRendering: function() {
            ...
            "<" + srcType + " class='" + src.className + "' dojoAttachPoint='" +
        ...
        dojo.extend(_chain, {
            ...
            _onEnd: function() {
                ...
                if (this._index + 1 == this._animations.length) {
                    ...
                    this._onAnimateCtx =
                    dojo.connect(this._current, "onAnimate", this, "_onAnimate");
    ...
    dojo.declare("dijit.form._FormMixin", null,
    {
        ...
        getValues: function() {
            ...
            dojo.forEach(this.getDescendants(), function(widget) {
                ...
                var value = (widget.getValue && !widget._getValueDeprecated) ? widget.getValue() :
                            widget.value;
...
if (!dojo._hasResource["dijit.Dialog"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        _onKey: function(/*Event*/ evt) {
            ...
            if (evt.keyCode) {
                ...
                if (node == this._firstFocusItem && evt.shiftKey && evt.keyCode == dojo.keys.TAB) {
                    ...
                    dojo.stopEvent(evt);
                } else if (node == this._lastFocusItem && evt.keyCode == dojo.keys.TAB &&
                           !evt.shiftKey) {
                    if (!singleFocusItem) {
            ...
            [dijit.layout.ContentPane, dijit._Templated, dijit.form._FormMixin, dijit._DialogMixin],
    {
        ...
        orient: function(/*DomNode*/ node, /*String*/ aroundCorner, /*String*/ corner) {
            ...
            this.domNode.className = "dijitTooltipDialog " + " dijitTooltipAB" +
        ...
        switch (node.nodeType) {
            ...
            //attributes appear in the dictionary order
                    ...
                    while ((m = reg.exec(s))) {
                        ...
                        if (key.substr(0, 3) != '_dj') {
                            ...
                            if (key == 'style') {
                                ...
                                attrarray.push([key, key == 'class' ? node.className :
                ...
                while ((attr = attrarray[i++])) {
                    output += ' ' + attr[0] + '="' +
                              (dojo.isString(attr[1]) ? dijit._editor.escapeXml(attr[1], true) :
                               attr[1]) + '"';
                }
            ...
            default:
                output =
                "Element not recognized - Type: " + node.nodeType + " Name: " + node.nodeName;
        }
        return output;
    };
    ...
    dojo.declare("dijit._editor.RichText", dijit._Widget, {
        ...
        _localizeEditorCommands: function() {
            ...
            while (node) {
                ...
                dojo.doc.queryCommandValue("formatblock");//this.queryCommandValue("formatblock");
                this._native2LocalFormatNames[this._local2NativeFormatNames[nativename]] =
                nativename;
        ...
        _drawIframe: function(/*String*/html) {
            ...
            if (!this.iframe) {
                ...
                if (label.length) {
                    ...
                    label[0].innerHTML + " " + this._localizedIframeTitles.iframeEditTitle;
                }
            }
            ...
            if (dojo.isIE) {
                if (e.keyCode == dojo.keys.TAB && e.shiftKey && !e.ctrlKey && !e.altKey) {
                    ...
                    this.execCommand("delete");
                           ...
                           (e.keyCode >= 37 &&
                            e.keyCode <= 40) // FIXME: get this from connect() instead!
                        ) { //arrow keys
        ...
        onKeyPress: function(e) {
            ...
            var modifiers = (e.ctrlKey && !e.altKey) ? this.KEY_CTRL :
                            0 | e.shiftKey ? this.KEY_SHIFT : 0;
...
if (!dojo._hasResource["dijit.form.Button"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        _onButtonClick: function(/*Event*/ e) {
            ...
            if (this._onClick(e) === false) { // returning nothing is same as true
                dojo.stopEvent(e);
                       ...
                       !this.focusNode.form) { // see if a nonform widget needs to be signalled
    ...
    dojo.declare("dijit.form.ToggleButton", dijit.form.Button, {
        ...
        setChecked: function(/*Boolean*/ checked) {
            ...
            dojo.deprecated("setChecked(" + checked +
                            ") is deprecated. Use setAttribute('checked'," + checked +
                            ") instead.", "", "2.0");
    ...
    dojo.declare("dijit._editor._Plugin", null, {
        ...
        _initButton: function(props) {
            if (this.command.length) {
                ...
                var className = this.iconClassPrefix + " " + this.iconClassPrefix +
...
if (!dojo._hasResource["dijit.Editor"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit._editor.RichText,
    {
                ...
                try {
                    ...
                    if (dojo.isMoz && /copy|cut|paste/.test(cmd)) {
                        ...
                        alert(sub(this.commands.systemShortcutFF,
                                [this.commands[cmd], sub(this.commands[isMac ? 'appleKey' :
                                                                       'ctrlKey'], [accel[cmd]])]));
                    }
                    return false;
                }
        ...
        _getBookmark: function() {
            ...
            if (dojo.isIE) {
                ...
                b = {startContainer:tmp,
                    ...
                    endContainer:b.endContainer === b.startContainer ? tmp :
        ...
        onKeyDown: function(e) {
            ...
            if (e.ctrlKey &&
                !e.altKey) {//undo and redo only if the special right Alt + z/y are not pressed #5892
                if (k == 90 || k == 122) { //z
                    dojo.stopEvent(e);
                    this.undo();
                    return;
            ...
            [dijit._Widget, dijit._Templated, dijit._KeyNavContainer],
    {
        ...
        _iframeContentDocument: function(/* HTMLIFrameElement */iframe_el) {
            ...
            var doc = iframe_el.contentDocument // W3
                    ...
                    || (iframe_el.name && dojo.doc.frames[iframe_el.name] &&
                        dojo.doc.frames[iframe_el.name].document)
                    || null;
        ...
        bindDomNode: function(/*String|DomNode*/ node) {
            ...
            node[this.id] = this._bindings.push([
                dojo.connect(cn, (this.leftClickToOpen) ? "onclick" :
                                 "oncontextmenu", this, "_openMyself"),
...
if (!dojo._hasResource["dojo.regexp"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    function(/*Object|Array*/arr, /*Function*/re, /*Boolean?*/nonCapture) {
        //	summary:
...
if (!dojo._hasResource["dojo.number"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    function(/*Number*/value, /*String*/pattern, /*dojo.number.__FormatOptions?*/options) {
        // summary:
    ...
    function(/*Number*/value, /*String*/pattern, /*dojo.number.__FormatAbsoluteOptions?*/options) {
        // summary:
        ...
        var maxPlaces = (options.places >= 0) ? options.places :
                        (patternParts[1] && patternParts[1].length) || 0;
        if (!(options.round < 0)) {
        ...
        if (options.places) {
            valueParts[1] =
            dojo.string.pad(fractional.substr(0, options.places), options.places, '0', true);
    ...
    dojo.number._integerRegexp = function(/*dojo.number.__IntegerRegexpFlags?*/flags) {
        ...
        var numberRE = dojo.regexp.buildGroupRE(flags.separator,
                function(sep) {
                    ...
                    if (grp2) {
                        var grp2RE = "(?:0|[1-9]\\d{0," + (grp2 - 1) + "}(?:[" + sep + "]\\d{" +
                                     grp2 + "})*[" + sep + "]\\d{" + grp + "})";
                        return ((grp - grp2) > 0) ?
                               "(?:" + grp2RE + "|(?:0|[1-9]\\d{0," + (grp - 1) + "}))" : grp2RE;
                    }
...
if (!dojo._hasResource["dijit.Tooltip"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit._Widget, dijit._Templated],
    {
        ...
        show: function(/*String*/ innerHTML, /*DomNode*/ aroundNode, /*String[]?*/ position) {
            ...
            dojo.forEach((position && position.length) ? position :
                         dijit.Tooltip.defaultPosition, function(pos) {
                switch (pos) {
                    case "after":
        ...
        orient: function(/* DomNode */ node, /* String */ aroundCorner, /* String */
                                       tooltipCorner) {
    ...
    dijit.showTooltip =
    function(/*String*/ innerHTML, /*DomNode*/ aroundNode, /*String[]?*/ position) {
        // summary:
...
if (!dojo._hasResource["dijit.Tree"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit._Widget, dijit._Templated],
    {
        ...
        _onItemChildrenChange: function(/*dojo.data.Item*/ parent, /*dojo.data.Item[]*/
                                                           newChildrenList) {
            //summary: set data event on an item in the store
            var model = this.model,
            ...
            null,
    {
        ...
        pasteItem: function(/*Item*/ childItem, /*Item*/ oldParentItem, /*Item*/
                                     newParentItem, /*Boolean*/ bCopy) {
            // summary
            ...
            if (oldParentItem) {
                dojo.forEach(this.childrenAttrs, function(attr) {
                    if (store.containsValue(oldParentItem, attr, childItem)) {
                        if (!bCopy) {
                            var values = dojo.filter(store.getValues(oldParentItem, attr), function(
                                    x) {
                                return x != childItem;
                            });
        ...
        onChildrenChange: function(/*dojo.data.Item*/ parent, /*dojo.data.Item[]*/
                                                      newChildrenList) {
            // summary
...
if (!dojo._hasResource["dijit.form.TextBox"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit.form._FormValueWidget,
    {
        ...
        setValue: function(value, /*Boolean?*/ priorityChange, /*String?*/ formattedValue) {
            ...
            if ((((typeof filteredValue == typeof value) && (value !== undefined/*#5317*/)) ||
                 (value === null/*#5329*/)) &&
            ...
            [dijit._Widget, dijit._Templated],
    {
        ...
        _onKeyPress: function(e) {
            ...
            if (this.autoSave) {
                ...
                setTimeout(
                        function() {
                            _this.saveButton.setAttribute("disabled", _this.getValue() ==
                                                                      _this._initialText);
                        }, 100);
            }
        },
...
if (!dojo._hasResource["dijit.form.ValidationTextBox"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit.form.ValidationTextBox,
    {
        ...
        toString: function() {
            ...
            return val != null ?
                   (typeof val == "string" ? val : this.serialize(val, this.constraints)) : ""; // String
        },
            ...
            dijit.form.MappedTextBox,
    {
        ...
        rangeCheck: function(/*Number*/ primitive, /*dijit.form.RangeBoundTextBox.__Constraints*/
                                        constraints) {
        ...
        isValid: function(/*Boolean*/ isFocused) {
            return this.inherited(arguments) &&
                   ((this._isEmpty(this.textbox.value) && !this.required) ||
                    this.isInRange(isFocused)); // Boolean
        },
...
if (!dojo._hasResource["dijit.form.ComboBox"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            null,
    {
        ...
        _announceOption: function(/*Node*/ node) {
            ...
            this.focusNode.value.substring(0, this._getCaretPos(this.focusNode));
        ...
        _startSearch: function(/*String*/ key) {
            ...
            this.searchTimer = setTimeout(dojo.hitch(this, function(query, _this) {
                ...
                this._nextSearch =
                this._popupWidget.onPage = dojo.hitch(this, nextSearch, dataObject);
...

    {
        ...
        clearResultList: function() {
            ...
            while (this.domNode.childNodes.length > 2) {
                this.domNode.removeChild(this.domNode.childNodes[this.domNode.childNodes.length -
                                                                 2]);
            }
        },
    ...
    dojo.declare("dijit.form._ComboBoxDataStore", null, {
        ...
        fetch: function(/* Object */ args) {
            ...
            var start = args.start || 0,
                    end = ("count" in args && args.count != Infinity) ? (start + args.count) :
                          items.length ;
...
if (!dojo._hasResource["dijit.form._DateTimeTextBox"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit.form.RangeBoundTextBox,
    {
        ...
        parse: function(/*String*/ value, /*dojo.date.locale.__FormatOptions*/ constraints) {
            ...
            /* can't return null to getValue since that's special */
        },
        ...
        setValue: function(/*Date*/ value, /*Boolean?*/ priorityChange, /*String?*/
                                    formattedValue) {
            // summary:
            ...
            if (!this._picker) {
                ...
                this._picker = new PopupProto({
                    ...
                    isDisabledDate: function(/*Date*/ date) {
                        ...
                        return constraints &&
                               (constraints.min && (compare(constraints.min, date, "date") > 0) ||
...
if (!dojo._hasResource["dijit.form._Spinner"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit.form.RangeBoundTextBox,
    {
        ...
        postCreate: function() {
            ...
            // extra listeners
            this.connect(this.textbox, dojo.isIE ? "onmousewheel" :
...
if (!dojo._hasResource["dijit.form.Slider"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit.form._FormValueWidget, dijit._Container],
    {
        ...
        _onKeyPress: function(/*Event*/ e) {
            ...
            switch (e.keyCode) {
                ...
                case ((this._descending || this.isLeftToRight()) ? dojo.keys.RIGHT_ARROW :
                      dojo.keys.LEFT_ARROW):
                case (this._descending === false ? dojo.keys.DOWN_ARROW : dojo.keys.UP_ARROW):
                case (this._descending === false ? dojo.keys.PAGE_DOWN : dojo.keys.PAGE_UP):
                    this.increment(e);
                    break;
                case ((this._descending || this.isLeftToRight()) ? dojo.keys.LEFT_ARROW :
        ...
        _onBarClick: function(e) {
            ...
            this._setPixelValue(this._isReversed() ? (abspos[this._pixelCount] - pixelValue) :
                                pixelValue, abspos[this._pixelCount], true);
        },

        _setPixelValue: function(/*Number*/ pixelValue, /*Number*/ maxPixels, /*Boolean, optional*/
                                            priorityChange) {
            if (this.disabled || this.readOnly) {
                return;
            }
            ...
            this.setValue((this.maximum - this.minimum) * wholeIncrements / count +
                          this.minimum, priorityChange);
        },
        ...
        setValue: function(/*Number*/ value, /*Boolean, optional*/ priorityChange) {
            ...
            if (priorityChange && this.slideDuration > 0 &&
        ...
        _bumpValue: function(signedChange) {
            ...
            count--;
            var value = (this.value - this.minimum) * count / (this.maximum - this.minimum) +
                        signedChange;
            if (value < 0) {
                value = 0;
            }
        ...
        postCreate: function() {
            ...
            this.connect(this.domNode, dojo.isIE ? "onmousewheel" :
                                       'DOMMouseScroll', "_mouseWheeled");
            ...
            dojo.dnd.Mover,
    {
        onMouseMove: function(e) {
            ...
            widget._setPixelValue_(widget._isReversed_ ? (abspos[widget._pixelCount] - pixelValue) :
                                   pixelValue, abspos[widget._pixelCount], false);
        },
    ...
    dojo.declare("dijit.form.HorizontalRule", [dijit._Widget, dijit._Templated],
    {
        ...
        _genHTML: function(pos, ndx) {
            return this._positionPrefix + pos + this._positionSuffix + this.ruleStyle +
                   this._suffix;
        },
        ...
        getLabels: function() {
            ...
            if (!labels.length && this.count > 1) {
                ...
                for (var i = 0; i < this.count; i++) {
                    labels.push((i < this.numericMargin || i >= (this.count - this.numericMargin)) ?
            ...
            dijit.form._FormValueWidget,
    {
        ...
        setValue: function(/*String*/ value, /*Boolean, optional*/ priorityChange) {
            ...
            if (this.iframe) {
                ...
                if (editNode.scrollWidth > editNode.clientWidth) {
                    newHeight += 16;
                } // scrollbar space needed?
                if (this.lastHeight !=
                    newHeight) { // cache size so that we don't get a resize event because of a resize event
                    if (newHeight == 0) {
                        newHeight = 16;
                    } // height = 0 causes the browser to not set scrollHeight
...
if (!dojo._hasResource["dijit.layout.StackContainer"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit._Widget, dijit._Templated, dijit._Container],
    {
        ...
        onSelectChild: function(/*Widget*/ page) {
            ...
            dijit.setWaiState(container.containerNode ||
                              container.domNode, "labelledby", newButton.id);
        },
...
if (!dojo._hasResource["dijit.layout.AccordionContainer"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit.layout.ContentPane, dijit._Templated, dijit._Contained],
    {
        ...
        _setSelectedState: function(/*Boolean*/ isSelected) {
            ...
            dojo[(isSelected ? "addClass" :
                  "removeClass")](this.titleNode, "dijitAccordionTitle-selected");
...
if (!dojo._hasResource["dijit.layout.BorderContainer"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit.layout._LayoutWidget,
    {
        ...
        _setupChild: function(/*Widget*/child) {
            ...
            if (region) {
                ...
                if (child.splitter) {
                    ...
                    var oppNodeList = dojo.query('[region=' + flip[child.region] +
                                                 ']', this.domNode);
        ...
        _layoutChildren: function(/*String?*/changedRegion) {
            ...
            if (sidebarLayout) {
                topStyle.left = bottomStyle.left =
                                leftWidth + (this.isLeftToRight() ? leftSplitterThickness : 0) +
                                "px";
                topStyle.right = bottomStyle.right =
                                 rightWidth + (this.isLeftToRight() ? 0 : rightSplitterThickness) +
                                 "px";
            } else {
    ...
    dojo.declare("dijit.layout._Splitter", [ dijit._Widget, dijit._Templated ],
    {
        ...
        _startDrag: function(e) {
            ...
            this._handlers = (this._handlers || []).concat([
                dojo.connect(de, "onmousemove", this._drag = function(e, forceResize) {
                    ...
                    splitterStyle[region] =
                    factor * delta + splitterStart + (boundChildSize - childSize) + "px";
                }),
        ...
        _onKeyPress: function(/*Event*/ e) {
            ...
            var childSize = dojo.marginBox(this.child.domNode)[ horizontal ? 'h' : 'w' ] +
                            this._factor * tick;
            var mb = {};
            mb[ this.horizontal ? "h" : "w"] =
            Math.max(Math.min(childSize, this._maxSize), this._minSize);
...
if (!dojo._hasResource["dijit.layout.SplitContainer"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            dijit.layout._LayoutWidget,
    {
        ...
        postCreate: function() {
            ...
            sizer.className = this.isHorizontal ? 'dijitSplitContainerVirtualSizerH' :
        ...
        _showSizingLine: function() {
            ...
            dojo.marginBox(this.virtualSizer,
                    this.isHorizontal ? { w: this.sizerWidth, h: this.paneHeight } :
...
if (!dojo._hasResource["dijit.layout.TabContainer"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit.layout.StackContainer, dijit._Templated],
    {
        ...
        layout: function() {
            ...
            dijit.layout.marginBox2contentBox(this.containerNode, children[1]);
