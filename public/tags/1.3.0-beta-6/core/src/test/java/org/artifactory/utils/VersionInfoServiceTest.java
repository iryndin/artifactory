...
public class VersionInfoServiceTest {
    ...
    public void testService() {
        ...
        EasyMock.expect(cacheService.getCache(ArtifactoryCache.versioning)).andReturn(map);
        ...
        String version1 = infoService.getLatestVersion(new HashMap<String, String>(), false);
