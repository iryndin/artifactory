...
import org.artifactory.webapp.wicket.panel.ArtifactoryPanel;
import org.artifactory.webapp.wicket.widget.CheckboxColumn;
 ...
 */
public class PermissionTargetRecipientsPanel extends ArtifactoryPanel {
    ...
    private void updateRow(Row row) {
        ...
        BasicAclEntry aclEntry = row.asAclEntry();
        aclDao.delete(aclEntry.getAclObjectIdentity(), aclEntry.getRecipient());
