 ...
 * @author Noam Y. Tenne
 */
@XmlType(name = "ReplicationType", propOrder = {"enabled", "cronExp", "syncDeletes", "syncProperties", "pathPrefix",
        "repoKey"}, namespace = Descriptor.NS)
public class ReplicationDescriptor implements Descriptor {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicationDescriptor)) {
            return false;
        }

        ReplicationDescriptor that = (ReplicationDescriptor) o;
