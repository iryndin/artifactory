...
LinksColumn.prototype.show = function() {
    ...
    var cord = dojo.coords(this.icon);
    ...
    this.panel.style.top = (cord.y - this.panel.scrollHeight / 2 + doc.scrollTop + 7) + 'px';
    this.panel.style.left = (cord.x - this.panel.scrollWidth + doc.scrollLeft + 5) + 'px';
