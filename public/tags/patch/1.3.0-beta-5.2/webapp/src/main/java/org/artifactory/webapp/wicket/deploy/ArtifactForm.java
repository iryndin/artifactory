...
public class ArtifactForm extends Form {
    ...
    private SimpleAjaxSubmitLink artifactSubmitButton;
    ...
    private void addSubmitFormButton() {
        artifactSubmitButton = new SimpleAjaxSubmitLink("artifactSubmit", this);
        artifactSubmitButton.setOutputMarkupId(true);
        add(artifactSubmitButton);
    }

    private void addTargetRepoDropDown() {
        PropertyModel targetRepoModel = new PropertyModel(ArtifactForm.this, "targetRepo");
    ...
    private void addCancelButton() {
        AjaxSubmitLink cancel = new AjaxSubmitLink("cancel") {
            protected void onSubmit(AjaxRequestTarget target, Form form) {
                cleanupResources();
                // create and navigaet to a new deploy page
                parent.setResponsePage(DeployArtifactPage.class);
            }
        };
    ...
    protected void onSubmit() {
        ...
        try {
            ...
            LOGGER.debug("Unable to deploy", e);
            Throwable cause = ExceptionUtils.unwrapThrowablesOfTypes(
                    e, RepoAccessException.class,
                    IllegalArgumentException.class);
            final String msg = "Failed to deploy artifact '" + deployableArtifact + "'. Cause: " +
                    cause.getMessage();
            error(msg);
        } finally {
            cleanupResources();
