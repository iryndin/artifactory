...
@AuthorizeInstantiation(ArtifactorySecurityManager.ROLE_USER)
public abstract class AuthenticatedPage extends BasePage {
    ...
    public AuthenticatedPage() {
        ...
        add(new BookmarkablePageLink("logoutPage", LogoutPage.class) {
            @Override
            public boolean isVisible() {
                return ArtifactorySession.get().isSignedIn() && !ArtifactorySecurityManager.isAnonymous();
            }
        });
    ...
    public String getUserName() {
        ...
        return "Logged in as: " + ArtifactorySecurityManager.getUsername();
    }
}
