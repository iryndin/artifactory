...
public class ImportZipPanel extends BasicImportPanel implements FileUploadParentPanel {
    ...
    public void onFileSaved() {
        ...
        try {
            ...
            File destFolder =
                    new File(ArtifactoryApp.UPLOAD_FOLDER, uploadedFile.getName() + "_extract");
            ...
            setImportFromPath(destFolder.getAbsolutePath());
    ...
    protected void cleanupResources() {
        ...
        if (getImportFromPath() != null) {
            try {
                FileUtils.deleteDirectory(new File(getImportFromPath()));
            } catch (IOException e) {
