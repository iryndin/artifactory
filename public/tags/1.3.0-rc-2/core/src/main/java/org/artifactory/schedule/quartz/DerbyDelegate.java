...
/**
 * A delegate for quartz with a derby db persistent store. Uses ps.setBinaryStream instead of
 * setBytes(PreparedStatement ps, int index, ByteArrayOutputStream baos) Please keep for future use
 * if we ever use db-based jobs again.
 */
