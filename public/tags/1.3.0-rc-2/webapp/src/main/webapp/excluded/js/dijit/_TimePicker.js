if (!dojo._hasResource["dijit._TimePicker"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
            ...
            [dijit._Widget, dijit._Templated],
    {
        ...
        _showText:function() {
            ...
            for (var i = -(this._totalIncrements >> 1); i < (this._totalIncrements >> 1);
        ...
        postCreate:function() {
            ...
            this.connect(this.timeMenu, dojo.isIE ? "onmousewheel" :
        ...
        _onArrowUp:function() {
            ...
            this.timeMenu.removeChild(this.timeMenu.childNodes[this.timeMenu.childNodes.length -
                                                               1]);
