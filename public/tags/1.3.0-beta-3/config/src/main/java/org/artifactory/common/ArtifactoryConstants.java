...
public abstract class ArtifactoryConstants {
    ...
    static final String SYS_PROP_LOCK_TIMEOUT_SECONDS = "artifactory.lockTimeoutSecs";
    ...
    public static final int lockTimeoutSecs = Integer.parseInt(System.getProperty(
            SYS_PROP_LOCK_TIMEOUT_SECONDS, "120"));
