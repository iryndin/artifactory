...
public class ShowScopeCommand extends ToggleCommand implements ApplicationContextAware, ApplicationListener {
    ...
    protected boolean onSelection(boolean b) {
        if (applicationContext != null) {
            ...
            FilterEvent.FilterActionType actionType = b ? FilterEvent.FilterActionType.REMOVE : FilterEvent.FilterActionType.ADD;
            applicationContext.getParent().publishEvent(new FilterEvent(this, epf, actionType));
        }
