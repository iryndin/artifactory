...
public class CoreAddonsImpl implements WebstartAddon, LdapGroupAddon, LicensesAddon, PropertiesAddon, LayoutsCoreAddon,
        ...
        ArtifactWatchAddon, ArtifactBuildAddon, UiNuGetAddon, LdapUserGroupAddon, GitLfsAddon,
    ...
    @Override
    public Boolean getAndResetBinaryProvidersStatus() {
        return false;
    }
    ...
    @Override
    public Command createGitLfsCommand(String command, TokenManager tokenManager) {
        return null;
    }
