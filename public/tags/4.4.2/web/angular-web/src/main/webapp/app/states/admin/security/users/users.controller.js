    ...
    getColumns() {
        return [
            ...
            },
            {
                ...
                displayName: "Locked",
                field: "locked",
                cellTemplate: '<div class="ui-grid-cell-contents text-center"><a class="grid-column-button icon icon-locked-unlock" ng-if="row.entity.locked" cm-aditional-action="Unlock" ng-click="grid.appScope.AdminSecurityUser.unlockUsers(row.entity.name)" jf-tooltip="Unlock"></a></div>',
                width: '7%'
            },
            {
