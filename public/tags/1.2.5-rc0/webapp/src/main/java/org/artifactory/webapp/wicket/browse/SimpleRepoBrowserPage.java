...
public class SimpleRepoBrowserPage extends AuthenticatedPage {
    ...
    public static final String PATH = "simpleRepoBrowser";

    public SimpleRepoBrowserPage() {
        add(new SimpleRepoBrowserPanel("browseRepoPanel"));
    }
    ...
    public String getDocumentBaseUri() {
        //Adjust the relative path so that it wont be computed base on the browsed repo directory
        //path in the request
