...
import static org.artifactory.jcr.JcrTypes.PROP_ARTIFACTORY_METADATA_NAME;
...
public class MetadataNamePropertyConverter implements ConfigurationConverter<JcrSession> {
    ...
    public void convert(JcrSession unManaged) {
        ...
        String queryStr = new StringBuilder().append("/jcr:root").append(JcrPath.get().getRepoJcrRootPath()).
