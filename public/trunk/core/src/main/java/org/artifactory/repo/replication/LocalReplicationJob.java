...
public class LocalReplicationJob extends QuartzCommand {
    ...
    protected void onExecute(JobExecutionContext callbackContext) throws JobExecutionException {
        ...
        LocalReplicationDescriptor replication = context.getCentralConfig().getDescriptor().getLocalReplication(
                repoKey);
        if (replication == null) {
            log.debug("Skipping execution of '{}', unable to find source repository '{}'.",
                    LocalReplicationJob.class.getName(), repoKey);
            return;
        }
