 ...
 * @author Shay Yaakov
 */
public class ModuleArtifactGroupableColumn extends GroupableColumn<ModuleArtifactActionableItem> {

    public ModuleArtifactGroupableColumn(IModel<String> displayModel, String sortProperty, String propertyExpression) {
