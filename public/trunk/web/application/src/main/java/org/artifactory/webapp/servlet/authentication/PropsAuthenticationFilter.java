...
public class PropsAuthenticationFilter implements ArtifactoryAuthenticationFilter {
    ...
    public boolean acceptFilter(ServletRequest request) {
        return PropsAuthenticationHelper.getTokenKeyValue((HttpServletRequest) request) != null;
    }
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        try {
            // try authenticate
            TokenKeyValue tokenKeyValue = PropsAuthenticationHelper.getTokenKeyValue(request);
