...
public class SmartRepoCapabilitiesDiscoveringService<T extends RemoteRepositoryConfigModel> extends RemoteRepositoryProvider implements RestService<T> {
    ...
    public void execute(ArtifactoryRestRequest<T> artifactoryRequest, RestResponse artifactoryResponse) {
        ...
        try {
            artifactoryResponse
                    .iModel(serialize(
                                    researchService.getSmartRepoCapabilities(
                                            remoteRepoUrl,
                                            client
                                    )
                           )
