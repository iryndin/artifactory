...
export class AdminConfigurationGeneralController {
    ...
    constructor($scope, $q, $timeout, FileUploader, ArtifactoryNotifications, GeneralConfigDao, FooterDao, ArtifactoryEventBus, ArtifactoryModelSaver, ArtifactActionsDao, ArtifactoryModal, SshServerDao) {
        this.$scope = $scope;
        this.$q = $q;
        ...
        this.SshServerDao.get().$promise.then((sshServer)=> {
            if (sshServer.enableSshServer) this.baseUrlIsRequired = true;
        });
