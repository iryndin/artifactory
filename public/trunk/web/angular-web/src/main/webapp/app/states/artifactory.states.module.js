...
function changeStateHook(User, $rootScope, $q, ArtifactoryNotifications, $location, $timeout, $state,
    ...
    $rootScope.$on('$stateChangeStart', (e, toState, toParams, fromState, fromParams) => {
        ...
        if (toState.name === 'login' && $location.path() !== '/login' && $location.path() !== '/forgot-password' && $location.path() !== '/change-password' && $location.path() !== '/oauth_error' && !$location.path().startsWith('/resetpassword')) {
