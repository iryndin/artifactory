...
package org.artifactory.common.wicket.behavior.combobox.history;
...
/**
 * Adding this behavior to DropDownChoice will convert it to Dojo ComboBox widget.<br/> <br/> <b>NOTE!</b> When using
 * this behavior will not be able add the dropdown to ajax target regularly, meaning <b>you can't do
 ...
 * @author Yoav Aharoni
 */
public class HistoryComboBoxBehavior extends TemplateBehavior {
    public HistoryComboBoxBehavior() {
        super(HistoryComboBoxBehavior.class);
    ...
    private String getCookieName() {
        return getComponent().getId() + ".hist";
    }
}