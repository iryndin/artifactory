...
public class TranslatedArtifactoryRequestTest extends ArtifactoryHomeBoundTest {
    ...
    private RepoPathImpl translatedRepoPath;
    private RepoPathImpl translatedMetadataRepoPath;
    private RepoPathImpl translatedChecksumRepoPath;
    ...
    public void setUp() throws Exception {
        ...
        translatedMetadataRepoPath = new RepoPathImpl("translatedRepoKey", "translatedRepoPath:maven-metadata.xml");
        translatedChecksumRepoPath = new RepoPathImpl("translatedRepoKey", "translatedRepoPath.md5");
    ...
    public void testGetName() throws Exception {
        assertEquals(translatedArtifactoryRequest.getName(), PathUtils.getName(translatedRepoPath.getPath()));
        assertEquals(translatedMetadataArtifactoryRequest.getName(),
                PathUtils.getName(translatedMetadataRepoPath.getPath()));
        assertEquals(translatedChecksumArtifactoryRequest.getName(),
                PathUtils.getName(translatedChecksumRepoPath.getPath()));
    }
