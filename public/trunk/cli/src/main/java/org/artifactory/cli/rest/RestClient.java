...
import org.artifactory.api.rest.SystemRestConstants;
...
public class RestClient {
     ...
     * URL for Rest API
     */
    public static final String SYSTEM_URL = SystemRestConstants.SYSTEM_PATH_ROOT;
    public static final String CONFIG_URL = SYSTEM_URL + "/" + SystemRestConstants.SYSTEM_PATH_CONFIGURATION;
    public static final String EXPORT_URL = SYSTEM_URL + "/" + SystemRestConstants.SYSTEM_PATH_EXPORT;
    public static final String IMPORT_URL = SYSTEM_URL + "/" + SystemRestConstants.SYSTEM_PATH_IMPORT;
    public static final String SECURITY_URL = SYSTEM_URL + "/" + SystemRestConstants.SYSTEM_PATH_SECURITY;
    public static final String COMPRESS_URL = SYSTEM_URL + "/" + SystemRestConstants.SYSTEM_PATH_STORAGE + "/" +
            SystemRestConstants.SYSTEM_PATH_STORAGE_COMPRESS;
