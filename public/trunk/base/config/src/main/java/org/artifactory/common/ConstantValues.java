...
public enum ConstantValues {
    ...
    passwordExpireJobIntervalSecs("security.password.expiry.passwordExpireJobIntervalSecs", 86400),
    passwordBeforeExpireNotificationStartInDays("security.password.expiry.passwordBeforeExpireNotificationStartInDays", 5),
