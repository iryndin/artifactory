...
public class ArchiveSearchResource {
     ...
     * @param response
     */
    public ArchiveSearchResource(SearchService searchService, HttpServletRequest request,
     ...
     * @param searchAllTypes True if should search through all file types, and not only classes
