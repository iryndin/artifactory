...
public class LocalRepositoriesMapAdapter
    ...
    public OrderedMap<String, LocalRepo> unmarshal(Wrappper wrapper) throws Exception {
    ...
    public Wrappper marshal(OrderedMap<String, LocalRepo> map) throws Exception {
        return new Wrappper(map);
    }

    @XmlType(name = "LocalRepositoriesType", namespace = CentralConfig.NS)
