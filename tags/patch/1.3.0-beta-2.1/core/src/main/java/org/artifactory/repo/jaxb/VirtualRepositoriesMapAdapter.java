...
public class VirtualRepositoriesMapAdapter
        extends
        XmlAdapter<VirtualRepositoriesMapAdapter.Wrappper, Map<String, VirtualRepo>> {
    @SuppressWarnings({"UNUSED_SYMBOL", "UnusedDeclaration"})
    private final static Logger LOGGER = Logger.getLogger(VirtualRepositoriesMapAdapter.class);


    public Map<String, VirtualRepo> unmarshal(Wrappper wrapper)
            throws Exception {
        Map<String, VirtualRepo> virtualRepositoriesMap =
                new HashMap<String, VirtualRepo>();
    ...
    public VirtualRepositoriesMapAdapter.Wrappper marshal(
            Map<String, VirtualRepo> map)
            throws Exception {
        return new VirtualRepositoriesMapAdapter.Wrappper(map);
    }


    @XmlType(name = "VirtualRepositoriesType", namespace = CentralConfig.NS)
    public static class Wrappper {
        ...
        public Wrappper(Map<String, VirtualRepo> map) {
