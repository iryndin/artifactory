    ...
    if ((!("console" in window) || !("firebug" in console)) &&
        ...
        (function() {
            ...
            function openWin(x, y, w, h) {
                var win = window.open("", "_firebug", "status=0,menubar=0,resizable=1,top=" + y +
                                                      ",left=" + x + ",width=" + w + ",height=" +
                                                      h + ",scrollbars=1,addressbar=0");
                if (!win) {
            ...
            function createResizeHandler(wn) {
                ...
                window.onFirebugResize = function() {
                    ...
                    wn._firebugWin_resize = setTimeout(function() {
                        ...
                        document.cookie =
                        "_firebugPosition=" + [x,y,w,h].join(",") + "; expires=" + d + "; path=/";
            ...
            function createFrame() {
                ...
                var closeStr = dojo.config.popup ? "" :
                ...
                addEvent(_firebugDoc, dojo.isIE || dojo.isSafari ? "keydown" :
                                      "keypress", onKeyDown);
            ...
            function layout(h) {
                var height = h ?
                             h - (consoleToolbar.offsetHeight + commandLine.offsetHeight + 25 +
                                  (h * .01)) + "px" :
                             consoleFrame.offsetHeight -
                             (consoleToolbar.offsetHeight + commandLine.offsetHeight) + "px";
            ...
            function logFormatted(objects, className) {
                ...
                for (i = objIndex + 1; i < objects.length; ++i) {
                    ...
                    if (object === undefined || object === null) {
                        ...
                        obs.push(object);
                        var str = '<a id="' + id + '" href="javascript:void(0);">' +
                ...
                for (i = 0; i < ids.length; i++) {
                    ...
                    _firebugWin.console._connects.push(dojo.connect(btn, "onclick", function() {
                        ...
                        consoleObjectInspector.innerHTML =
                        bkBtn + "<pre>" + printObject(this.obj) + "</pre>";
                    }));
                }
            }
            ...
            function onCommandLineKeyDown(event) {
                if (event.keyCode == 13 && commandLine.value) {
                    ...
                    commandLine.value = "";
                           ...
                           event.charCode == dojo.keys.UP_ARROW) {
                    navigateHistory("older");
                } else if (event.keyCode == dojo.keys.DOWN_ARROW ||
                           event.charCode == dojo.keys.DOWN_ARROW) {
                ...
                looking:
                        for (var nm in o) {
                            if (o[nm] === window || o[nm] === document) {
                                ...
                                if (o[nm].nodeType == 1) {
                                    txt += i + nm + " : < " + o[nm].tagName + " id=\"" + o[nm].id +
                                           "\" />" + br;
                                } else if (o[nm].nodeType == 3) {
                                    txt += i + nm + " : [ TextNode " + o[nm].data + " ]" + br;
                                }
                            } else if (typeof o[nm] == "object" &&
                                       (o[nm] instanceof String || o[nm] instanceof Number ||
