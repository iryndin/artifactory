...
public abstract class RemoteRepoBase extends RealRepoBase implements RemoteRepo {
        ...
        try {
            ...
            if (res == null) {
                ...
                if (!offline) {
                    ...
                    res = new UnfoundRepoResource(path, this);
                    if (LOGGER.isDebugEnabled()) {
                        LOGGER.debug(
    ...
    public ResourceStreamHandle getResourceStreamHandle(RepoResource res)
        ...
        if (storeArtifactsLocally) {
            ...
            try {
                ...
                if (!offline && (!targetRes.isFound() ||
                        res.getLastModified() > targetRes.getLastModified())) {
