 ...
 * @author Yoav Aharoni
 */
public class ArtifactLocatorPanel extends WindowPanel {
    ...
    public ArtifactLocatorPanel(String string) {
        ...
        add(pomDialogPanel);
        add(new HelpBubble("searchHelp",
                "Artifact name or keywords to search (wildcards accepted)"));
        ...
        columns.add(new PropertyColumn(
                new Model("Repository"), "repoKey", "repoKey"));
