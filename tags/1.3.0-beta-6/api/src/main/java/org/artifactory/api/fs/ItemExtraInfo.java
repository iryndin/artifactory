 ...
 * @date Oct 12, 2008
 */
public class ItemExtraInfo implements Info {
    ...
    public ItemExtraInfo(ItemExtraInfo extension) {
    ...
    public boolean isIdentical(ItemExtraInfo extraInfo) {
        return this.lastUpdated == extraInfo.lastUpdated &&
                this.modifiedBy == extraInfo.modifiedBy &&
                PathUtils.safeStringEquals(this.createdBy, extraInfo.createdBy);
    }
}
