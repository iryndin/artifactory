...
public class UploadServiceImpl implements InternalUploadService {
    ...
    public void process(ArtifactoryRequest request, ArtifactoryResponse response)
        ...
        InternalUploadService transactionalMe =
                InternalContextHelper.get().beanForType(InternalUploadService.class);
    ...
    public void doProcess(ArtifactoryRequest request, ArtifactoryResponse response, LocalRepo repo,
        ...
        InputStream is = null;
        FileInfo dummyInfo = jcrFile.getInfo();
        ...
        try {
            SimpleRepoResource res = new SimpleRepoResource(dummyInfo);
    ...
    private static int getLastBuildNumber(final LocalRepo repo, final String versionMetadataPath) {
        ...
        JcrFile file = null;
        try {
            file = repo.getLockedJcrFile(versionMetadataPath, true);
