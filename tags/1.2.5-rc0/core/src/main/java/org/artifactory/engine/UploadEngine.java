                ...
                if (nonUniqueSnapshotVersions) {
                    ...
                    final String versionMetadataPath =
                            path.substring(0, path.lastIndexOf("-SNAPSHOT/") + 10) +
                                    "maven-metadata.xml";
                    int buildNum = getLastBuildNumber(repo, versionMetadataPath, jcr);
                ...
                try {
                    ...
                    if (versioning != null) {
                        ...
                        if (nonUniqueSnapshotVersions && snap != null &&
                            ...
                            int buildNum = getLastBuildNumber(repo, path, jcr);
