...
@XmlType(name = "RepoType", propOrder = {"key", "description", "blackedOut",
        "handleReleases", "handleSnapshots", "maxUniqueSnapshots",
        "includesPattern", "excludesPattern"})
public abstract class RepoBase implements Repo {
    ...
    public abstract int getMaxUniqueSnapshots();

    public abstract void setMaxUniqueSnapshots(int maxUniqueSnapshots);
