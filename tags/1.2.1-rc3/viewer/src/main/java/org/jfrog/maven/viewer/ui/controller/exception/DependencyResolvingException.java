 ...
 */
package org.jfrog.maven.viewer.ui.controller.exception;
...
public class DependencyResolvingException extends RuntimeException {
    public DependencyResolvingException(Exception e) {
        super(e);
    }
    ...
    public DependencyResolvingException(Throwable cause) {
        super(cause);
    }
}
