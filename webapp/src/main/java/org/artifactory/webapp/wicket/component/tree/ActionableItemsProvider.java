...
public interface ActionableItemsProvider {
    ...
    List<ActionDescriptorTarget> getActionDescriptorTargets();

    NodeActionListener getNodeActionListener();

    Panel getNodeDisplayPanel();

    void setNodeDisplayPanel(Panel panel);
}
