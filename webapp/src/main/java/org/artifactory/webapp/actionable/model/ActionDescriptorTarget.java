...
public class ActionDescriptorTarget implements Serializable {
    ...
    private final static Logger LOGGER = Logger.getLogger(ActionDescriptorTarget.class);
    ...
    public ActionDescriptorTarget(ActionDescriptor descriptor, Component target) {
        this(descriptor, target, null);
    }

    public ActionDescriptorTarget(ActionDescriptor descriptor, Component target,
            CharSequence actionConfirmationPrefix) {
