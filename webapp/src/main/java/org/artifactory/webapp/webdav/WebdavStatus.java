 ...
 * protocols we would only need to modify this class.
 *
 * @author Marc Eaddy
...
public class WebdavStatus {
    ...
    /**
     * Status code (422) indicating the entity body submitted with the PATCH method was not
     * understood by the resource.
     */
    public static final int SC_UNPROCESSABLE_ENTITY = 422;

    /**
     * Status code (507) indicating that the resource does not have sufficient space to record the
     * state of the resource after the execution of this method.
     */
    public static final int SC_INSUFFICIENT_SPACE_ON_RESOURCE = 507;

    /**
     * Status code (424) indicating the method was not executed on a particular resource within its
    ...
    /**
     * Adds a new status code -> status text mapping.  This is a static method because the mapping
