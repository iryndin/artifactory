 ...
 * when using custom Log4J initialization.</p>
 * <p>Fred Simon: Added the autmatic copy of log4j.properties from default resource</p>
 *
...
public class Log4jConfigListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ArtifactoryHome.checkLog4j(event.getServletContext().getInitParameter(Log4jWebConfigurer.CONFIG_LOCATION_PARAM));
