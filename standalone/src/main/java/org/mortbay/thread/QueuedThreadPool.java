...
//
// Based on: http://dev.eclipse.org/svnroot/rt/org.eclipse.jetty/jetty/tags/jetty-7.0.0.RC6/jetty-util/src/main/java/org/eclipse/jetty/util/thread/QueuedThreadPool.java
// ========================================================================
...
public class QueuedThreadPool extends AbstractLifeCycle implements ThreadPool, Executor
{
    ...
    {
        Log.info("Using new version of QueuedThreadPool (Jetty jetty-7.0.0.RC6)");
        _name="qtp-jetty7-"+super.hashCode();
    }
