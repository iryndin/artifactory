...
public interface JcrService extends ReloadableBean {
     ...
     */
    @Lock(transactional = true)
    ArtifactCount getArtifactCount(@Nullable String repoKey);
     ...
     */
    @Lock(transactional = true)
    List<JcrFile> getPluginPomFiles(JcrFsItemFactory repo);
     ...
     * @throws org.artifactory.sapi.common.RepositoryRuntimeException
