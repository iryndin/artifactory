...
public class ArtifactoryServer {
    ...
    /**
     * Finds where the artifactory webapp dir is and sets a system property for jetty to use.
     * The relative path to the webapp dir might be deferent if the test is executed from maven
     * or from the ide.
     */
